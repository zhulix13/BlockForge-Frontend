...
import { ClipboardCheck, CheckCircle2, Clock, XCircle, Search, Eye, Filter } from "lucide-react";
  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        <div>
          <h2 className="text-xl sm:text-2xl font-bold text-stone-100 tracking-tight">My Submissions</h2>
          <p className="text-sm text-stone-500 mt-1">Track the status of your task proof submissions.</p>
        </div>
              ...
              {isLoading ? (
                ...
                <tr>
                  <td colSpan={4} className="px-6 py-20 text-center">
                    ...
                    <p className="text-sm text-stone-500 font-medium">No submissions found matching this filter.</p>
                  </td>
                </tr>
              ) : (
                submissions.map((sub) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-1">
                        <span className="text-sm font-black tabular-nums text-stone-300">${sub.task.rewardUsdc}</span>
                        <span className="text-[9px] font-bold text-stone-600 uppercase tracking-widest">USDC</span>
                      </div>
                    </td>
                    <td className="px-6 py-4">
